    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stauts', models.SmallIntegerField(choices=[(0, '下线'), (1, '上线')], default=1, verbose_name='状态')),
            ],
            options={
                'verbose_name': '商品SKU',
        ...
        migrations.AddField(
            model_name='goods',
            name='goodsspu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='goods.GoodsSPU', verbose_name='商品SPU'),
        ),
        migrations.AddField(
            model_name='goods',
            name='goodstype',
